...
public class metodosEjercicioAmpliacion {
    public static void main(String[] args) throws IOException {
        ...
        char [] textoEnChar = cambiarPalabra(frase);
    ...
    public static char [] cambiarPalabra(char [] textoEnChar) {
        String oldPalabraString = "mancha";
        int tamOldPalabraString = oldPalabraString.length();
        String newPalabraString = "perro";
        int tamNewPalabraString = newPalabraString.length();

        char [] newPalabraChar = newPalabraString.toCharArray();
